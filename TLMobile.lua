...
local SavedPanel, SavedTitleBar, SavedTitleName, SavedTitleSub, SavedCloseBtn, SavedScroll, SavedEmpty = (function()
    ...
    SavedIcon.Text = "★"; SavedIcon.Size = UDim2.fromOffset(20,22); SavedIcon.Position = UDim2.fromOffset(14,6)
    SavedIcon.BackgroundTransparency = 1; SavedIcon.TextSize = 15; SavedIcon.TextColor3 = C.ACCENT
    ...
    SavedTitleName.Position = UDim2.fromOffset(36,6); SavedTitleName.BackgroundTransparency = 1
    ...
    SavedTitleSub.Position = UDim2.fromOffset(36,28); SavedTitleSub.BackgroundTransparency = 1
